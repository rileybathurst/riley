...
if (have_posts()) {
	...
	<div class="article-content-specific">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>qcrxtankmoto_0080-large/">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>dirt-masters-2015/qcr_dirt_day_0069/">
			<img src="<?php echo content_url(); ?>/uploads/2015/09/QCR_Dirt_Day_0069.jpg" alt="qcr mopeds at dirt day">
		</a>
			
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>earnest-workshop-wednesdays/qcr_pigeon_bay-182/">
			<img src="<?php echo content_url(); ?>/uploads/2015/05/QCR_Pigeon_Bay-182.jpg" alt="quake city rumblers moped burn out">		</a>
			
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>run-photos/run_to_the_guns_0446-700/">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>dirt-day/dirtday2-blog/">
			<img src="<?php echo content_url(); ?>/uploads/2015/06/DirtDay2-blog.jpg" alt="moped gang poster">
			
		</a>
			
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>run-to-the-guns-2/run-to-the-guns-700-2/">
