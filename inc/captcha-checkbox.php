<?php
// deals with checkbox form sent through form _POST
function prefix_admin_checkbox() {
	...
	exit();
} // closes out the prefix_admin_checkbox

add_action( 'admin_post_checkbox', 'prefix_admin_checkbox' );
add_action( 'admin_post_nopriv_checkbox', 'prefix_admin_checkbox' );
