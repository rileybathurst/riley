...
if (have_posts()) {
	...
	<div class="article-content-specific">
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>josh-o-half-cab-diptych-medium/">
		...
		<h4><a href="<?php echo esc_url( home_url( '/' ) ); ?>josh-o-half-cab-diptych-medium/">Josh O - Diptych</a><br />
			The right image was printed in Wake Magazine</h4>
			
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>andrew-pastura-first-roll/">
			<picture class="lozad-picture">
		...
		<h4><a href="<?php echo esc_url( home_url( '/' ) ); ?>andrew-pastura-first-roll/">Andrew Pastura - First Roll, Tahoe. CA</a></h4>
			
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>2013/02/brad-smeele-nollie/brad-ski-jump-nollie1/">
			<img src="<?php echo content_url(); ?>/uploads/2013/02/Brad-Ski-Jump-Nollie1-1.jpg" alt="brad smeele ski jump wakeboard nolie">
		</a>
		<h4><a href="<?php echo esc_url( home_url( '/' ) ); ?>2013/02/brad-smeele-nollie/brad-ski-jump-nollie1/">Brad Smeele Nollie</a><br />
