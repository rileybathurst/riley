...
if (have_posts()) {
	...
	<div class="article-content-specific">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>the-vintage-peddler-flyer/">
			<img src="<?php echo content_url(); ?>/uploads/2013/02/Vintage-Peddler-DLE-season-2.jpg" alt="the vinatge peddler dle design">
			
		</a>
		<h4><a href="<?php echo esc_url( home_url( '/' ) ); ?>the-vintage-peddler-flyer/">DLE Design</a></h4>
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>vp_shoot_2012_0044/">
		...
		<h4><a href="<?php echo esc_url( home_url( '/' ) ); ?>vp_shoot_2012_0044/">Miss Peddles</a></h4>
