...
if (have_posts()) {
	...
	<div class="article-content-specific">
		...
		<div class="specific-grid">
			<h3>Photography</h3>
			<p class="subtitle hide-for-medium" style=" grid-row:4; align-self: end;">Photography</p>
...
<!-- Im removing this one to fit to the 3 column grid not because I don't like the image
			<picture class="lozad-picture specific-grid__main-width ">
