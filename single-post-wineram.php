...
if (have_posts()) {
	...
	<div class="article-content-specific">
		...
		<div class="specific-grid">
			...
			<div class="continental west-medium gr-1-m responsive-embed widescreen frame" style="--aspect-ratio: 16/9;">
			...
			<div class="specific-grid">
				...
				<section class="continental west-medium gr-1-m responsive-embed widescreen frame" style="--aspect-ratio: 16/9;">
