...
<div class="background-primary">
	<div class="front-page-titles">
		<div class="fp-box social-west"></div>

		<div class="social-icons">
			<div class="fp-box">
				<a href="https://www.instagram.com/rileybathurst/">
					<svg id="icon-instagram" viewBox="0 0 27 32">
			...
			<div class="fp-box">
				<a href="https://www.linkedin.com/in/rileybathurst/">
					<svg id="icon-linkedin" viewBox="0 0 27 32">
			...
			<div class="fp-box">
				<a href="https://github.com/rileybathurst">
					<svg id="icon-github" viewBox="0 0 27 32">
		...
		<div class="fp-box social-east"></div>
	</div>
</div>
