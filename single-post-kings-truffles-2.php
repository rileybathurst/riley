	...
	<div class="article-content-specific">
		<a href="http://rileybathurst.com/kings_truffles_0498/">
			<picture class="lozad-picture">
				...
				<img src="<?php echo content_url(); ?>/uploads/2018/05/Kings_Truffles_0498-small.jpg" alt="kings truffle dogs">
			</picture>
		</a>
		...
		<a href="http://rileybathurst.com/kings_truffles_0707/">
			<picture class="lozad-picture">
				...
				<img src="<?php echo content_url(); ?>/uploads/2018/05/Kings_Truffles_0707-small.jpg" alt="kings truffle dogs">
			</picture>
		</a>
		...
		<a href="http://rileybathurst.com/kings_truffles_0698/">
			<picture class="lozad-picture">
				...
				<img src="<?php echo content_url(); ?>/uploads/2018/05/Kings_Truffles_0698-small.jpg" alt="kings truffle dogs">
			</picture>
		</a>
		...
		<a href="http://rileybathurst.com/kings_truffles_0610/">
			<picture class="lozad-picture">
				...
				<img src="<?php echo content_url(); ?>/uploads/2018/05/Kings_Truffles_0610-small.jpg" alt="kings truffle dogs">
			</picture>
		</a>
